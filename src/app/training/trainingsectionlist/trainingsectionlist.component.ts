...
export class TrainingsectionlistComponent implements OnInit {
  ...
  constructor(public ApiService:ApiService,public router:Router,public http:HttpClient,public modalservices:BsModalService,public cookie:CookieService,public sanitizer: DomSanitizer)
  {
  ...
  delete(template:TemplateRef<any>)
  {
   ...
   //   this.http.post(link,{source:'trainingsection'})
    ...
    showimag(img){
     ...
     //   console.log(this.ApiService.fileimgsslurl+tempvar);
        return this.ApiService.fileimgsslurl+tempvar;
      //  console.log(this.ApiService.uploadsslurl+tempvar);
    }
}
