...
public sourcecondition:any={};
  ...
  this.formdata=[
    ...
    {inputtype:'select',name:'parentcategory',label:'Parent Category',defaultchoice:'Select Category',sourceview:'tranningcategory',sourcetype:'',selectvalue:'categoryname',selectid:'_id'},
